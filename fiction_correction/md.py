...
nameList = {"阳大根","昊明","性福","葵","站街","慢着","筱葵","昊宁妃","昊天","昊明"}
...
if __name__ == '__main__':
    ...
    md_file = "/Users/xuanchengwei/my-data/core/H/extraordinary-fiction/娇妻美妾任君尝/娇妻美妾任君尝_第一部/娇妻美妾任君尝_第一部.md"
    ...
    for l in lines:
        ...
        if errors:
            ...
            print("{} => {}".format(error_sentence, errors))